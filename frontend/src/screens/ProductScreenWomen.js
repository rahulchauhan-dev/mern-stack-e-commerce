...
import { addToWishWomen } from '../actions/wishActions'


const ProductScreenWomen = ({ history, match }) => {
    ...
    useEffect(() => {
        ...
        dispatch(productDetailsWomen(match.params.category, match.params.id))
    ...
    const addToWishHandler = () => {
        dispatch(addToWishWomen(match.params.id))
    }


    const submitHandler = (e) => {
        e.preventDefault()
        dispatch(createWomenProductReview(match.params.id, {
            rating, comment
        }))
    }
